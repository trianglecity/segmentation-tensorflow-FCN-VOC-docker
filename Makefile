...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/home/deeplearning/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/home/deeplearning/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/home/deepleaning/$(BIND_DIR)")
...
UBUNTU_IMAGE := tensorflow-dev:01
